            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <input class="form-control" type="text" id="descripcion_agregar" autofocus="true" placeholder="Nuevo Pais">
                  <input class="form-control" type="text" id="gentilicio_agregar" autofocus="true" placeholder="Nuevo Gentilicio">
                </div>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <input class="form-control" type="text" id="gentilicio_editar" value="" autofocus="true">
