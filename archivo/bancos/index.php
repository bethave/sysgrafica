            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <input class="form-control" type="text" id="descripcion_agregar" autofocus="true" placeholder="Nueva Descripcion">
                  <input class="form-control" type="text" id="tel_agregar" autofocus="true" placeholder="Nuevo Telefono">
                  <input class="form-control" type="email" required="" id="email_agregar" autofocus="true" placeholder="Nuevo Email">
                  <input class="form-control" type="text" id="direc_agregar" autofocus="true" placeholder="Nueva Direccion">
                </div>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <input class="form-control" type="text" id="tel_editar" value="" autofocus="true">
                  <input type="hidden" id="tel_anterior_editar" value="">
