...
$resultado = pg_query($conexion, 
    "SELECT * FROM v_venta_factura_reporte");
...
$pdf->SetSubject('FACTURA DEL CLIENTE');
...
<table cellspacing="0" cellpadding="1" border="1">
 <tr>
<td colspan="8" width="638"><p align="center"><b>DATOS DE LA FACTURA</b></p></td>
</tr>
</table>
<table cellspacing="0" cellpadding="1" border="1">
    <tr>
        <td colspan="2"><p align="left"><b>NRO FACTURA</b> <br align="center">$pre_cod</p></td>
    ...
    <tr>
        <td colspan="3"><p align="left"><b>ESTADO DE FACTURA</b> <br align="center">$estado</p></td>
        <td colspan="3"><p align="left"><b>FUNCIONARIO</b> <br align="center">$id_fun</p></td>
        <td colspan="2"><p align="left"><b>EN BASE A PRESUPUESTO</b> <br align="center">$con_ped</p></td>
    </tr>
</table>
...
// This method has several options, check the source code documentation for more information.
$pdf->Output('example_factura_venta.pdf', 'I');
