...
$resultado = pg_query($conexion, 
    "SELECT * from v_compra_pedido");

$resultado2 = pg_query($conexion, 
    "SELECT * from v_compra_pedido_detalle");
...
$pdf->SetHeaderData('ferre.png', '12', 'PEDIDO COMPRA', 'FERRESHOP S.A');
...
<table cellspacing="0" cellpadding="1" border="1">
 <tr>
<td colspan="6" width="638"><p align="center"><b>DATOS DEL PEDIDO COMPRA</b></p></td>
</tr>
</table>
<table cellspacing="0" cellpadding="1" border="1">
    <tr>
    ...
    <tr>
        <td colspan="3"><p align="left"><b>PROVEEDOR</b> <br align="center">$id_pro - $pro</p></td>
        <td colspan="3"><p align="left"><b>SUCURSAL</b> <br align="center">$sucid - $suc</p></td>
    </tr>
</table>
...
<table cellspacing="0" cellpadding="1" border="1">
	...
	<td colspan="2"><p align="center"><br>$item</p></td>
        <td colspan="2"><p align="center"><br>$descri</p></td>
        <td colspan="2"><p align="center"><br>$canti</p></td>
        <td colspan="2"><p align="center"><br>$precio</p></td>
        <td colspan="2"><p align="center"><br>$iva</p></td>
        <td colspan="2"><p align="center"><br>$monto</p></td>
        </tr> 
...
// This method has several options, check the source code documentation for more information.
$pdf->Output('example_pedido_compra.pdf', 'I');
