...
function grabar_cabecera(){
    ...
    var id_pro;
    var con_pedido;
    tip_fac = $("#id_tf_cabecera").val();
    fac_cuotas = $("#id_cuota_cabecera").val();
    fac_timnro = $("#id_tim_cabecera").val();
    id_pro = $("#id_pro_cabecera").val();
    fac_vto = $("#id_fin_cabecera").val();
    fac_nro = $("#id_nf_cabecera").val();
    fac_inicio = $("#id_inicio_cabecera").val();
    intervalo = $("#id_intervalo_cabecera").val();
    ...
    type: "POST", url: "grabar.php",
      data: {
          ...
          fac_timnro: fac_timnro,
          fac_vto: fac_vto,
          con_pedido: con_pedido,
          id_pro: id_pro, 
          fac_nro: fac_nro,
          fac_inicio: fac_inicio,
          intervalo: intervalo,
          id_ped: '0', 
          id_item: '0', 
          cantidad: '0', 
