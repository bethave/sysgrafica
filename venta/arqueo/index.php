            ...
            <div class="card">
                <div class="card-header p-0">
                    <ul class="nav nav-pills ml-auto p-2">
                        <li class="nav-item"><a class="nav-link active" href="#panel-orden" id="btn-panel-orden" data-toggle="tab">Cierre</a></li>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            INGRESE NUEVA CANTIDAD EFECTIVO
                            <input class="form-control" type="number" id="efectivo_editar" value="">
                            <input type="hidden" id="id_ped_editar" value="">
                        </div>
                        <div class="modal-body">
                            INGRESE NUEVA CANTIDAD CHEQUE
                            <input class="form-control" type="number" id="cheque_editar" value="">
                            <input type="hidden" id="id_ped_editar" value="">
                        </div>
                        <div class="modal-body">
                            INGRESE NUEVA CANTIDAD TARJETA
                            <input class="form-control" type="number" id="tarjeta_editar" value="">
                            <input type="hidden" id="id_ped_editar" value="">
                        </div>
                        <div class="modal-body">
                            INGRESE NUEVA CANTIDAD FALTANTE
                            <input class="form-control" type="number" id="faltante_editar" value="">
                            <input type="hidden" id="id_ped_editar" value="">
                        </div>
                        <div class="modal-body">
                            INGRESE NUEVA CANTIDAD SOBRANTE
                            <input class="form-control" type="number" id="sobrante_editar" value="">
                            <input type="hidden" id="id_ped_editar" value="">
                        </div>
