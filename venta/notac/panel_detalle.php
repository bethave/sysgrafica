<?php
	...
	$pedidos = pg_query($conexion, "SELECT * FROM v_venta_factura;");
 	$ped = pg_fetch_all($pedidos);
        $pedidos_detalles = pg_query($conexion, "SELECT * FROM v_venta_factura_detale WHERE fac_cod IN (SELECT fac_cod FROM venta_factura);");
