      ...
      <div class="content-wrapper">
        <div class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1 class="m-0 text-dark">APERTURA DE CAJA</h1>
                ...
                <input type="hidden" id="btn-modal-insert" data-toggle="modal" data-target="#modal-insert">
              </div>
              <div class="col-sm-6">
        ...
        <section class="content">
            <div class="card">
                <div class="card-header p-0">
                    <ul class="nav nav-pills ml-auto p-2">
                        <li class="nav-item"><a class="nav-link active" href="#panel-orden" id="btn-panel-orden" data-toggle="tab">APERTURA</a></li>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            INGRESE LA NUEVO MONTO INICIAL
            ...
            <div class="modal fade" id="modal-insert">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">ABRIR</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            INGRESE EL NUEVO MONTO INICIAL
                            <input class="form-control" type="number" id="cantidad_insert" value="">
                            <input type="hidden" id="id_ped_insert" value="">
                       <label>SELECCIONE CAJA</label>
                        <select id="caja_insert" class="form-control select2">
                        <?php $conexion = conexion::conectar();
                        $r_pais = pg_query($conexion, "SELECT * FROM caja WHERE c_estado = 'ABIERTO';");
                        $pais = pg_fetch_all($r_pais);
                        ?>
                        <?php foreach($pais as $c){ ?>
                        <option value="<?php echo $c['caja_id']; ?>"> <?php echo $c['caja_descri']; ?></option>
                        <?php } ?>
                        </select>
                        </div>
                        
                        <div class="modal-footer justify-content-between">
                            <button type="button" class="btn btn-default" data-dismiss="modal" id="btn_cerrar_insert">Cerrar</button>
                            <button type="button" class="btn btn-primary" onclick="grabar_insert();">Grabar</button>
                        </div>
                    </div>
                </div>
            </div>
