...
<html>
  ...
  <body class="hold-transition sidebar-mini layout-fixed">
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                    ...
                    <LABEL>REPORTE - CAJA </LABEL>&nbsp;&nbsp;<img src="../../iconos/fascy2.png" width="70px" height="60px">
                </div>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <h4 class="modal-title">BUSCAR POR RANGO DE CÓDIGO</h4>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
                <div class="modal-body">
                    <lable>BUSCAR DESDE:</lable><input class="form-control" type="number" id="desde_agregar" autofocus="true" placeholder="Ingrese número desde">
                    <lable>BUSCAR HASTA:</lable><input class="form-control" type="number" id="hasta_agregar" autofocus="true" placeholder="Ingrese número hasta">
                </div>
                <div class="modal-footer justify-content-between">
                  <button type="button" class="btn btn-default" data-dismiss="modal" id="btn_cerrar_agregar">CERRAR</button>
                  <button type="button" class="btn btn-primary" onclick="grabar('1');">BUSCAR</button>
                </div>
              </div>
            </div>
          </div>
    ...
    <script src="funciones_caja.js"></script>
