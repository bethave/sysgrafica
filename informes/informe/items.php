...
<html>
  ...
  <body class="hold-transition sidebar-mini layout-fixed">
      ...
      <div class="content-wrapper">
        <div class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-8">
                  <h1 class="m-0 text-left"><b>KAMBA FERRETERÍA</b></h1>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                    ...
                    <LABEL>REPORTE - ITEMS </LABEL>&nbsp;&nbsp;<img src="../../iconos/kamba1.ico" width="70px" height="60px">
                </div>
    ...
    <script src="funciones_items.js"></script>
