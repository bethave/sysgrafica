      ...
      <div class="content-wrapper">
        <div class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-11">
                  <h1 class="m-0 text-dark text-center"><b>INFORMES VENTAS</b></h1>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                     <form action="pedido.php" class="form-inline" method="POST" target="_blank">
                        <h5 class="col-sm-4"><b>INFORME - PEDIDO VENTA</b></h5><input type="submit" class="btn btn-block btn-warning col-sm-1" value="VISUALIZAR"><BR>
                    </form>
                    <hr>
                    <dl></dl>
                    <form action="presupuesto.php" class="form-inline" method="POST" target="_blank">
                        <h5 class="col-sm-4"><b>INFORME - PRESUPUESTO VENTA</b></h5><input type="submit" class="btn btn-block btn-warning col-sm-1" value="VISUALIZAR"><BR><BR>
                    </form>
                    <hr>
                    <dl></dl>
                    <form action="factura.php" class="form-inline" method="POST" target="_blank">
                        <h5 class="col-sm-4"><b>INFORME - FACTURA VENTA</b></h5><input type="submit" class="btn btn-block btn-warning col-sm-1" value="VISUALIZAR"><BR><BR>
                    </form>
                    <hr>
                    <dl></dl>
                    <form action="apertura.php" class="form-inline" method="POST" target="_blank">
                        <h5 class="col-sm-4"><b>INFORME - APERTURA DE CAJA VENTA</b></h5><input type="submit" class="btn btn-block btn-warning col-sm-1" value="VISUALIZAR"><BR><BR>
                    </form>
                    <hr>
                    <dl></dl>
                    <form action="cierre.php" class="form-inline" method="POST" target="_blank">
                        <h5 class="col-sm-4"><b>INFORME - CIERRE / ARQUEO DE CAJA VENTA</b></h5><input type="submit" class="btn btn-block btn-warning col-sm-1" value="VISUALIZAR"><BR><BR>
                    </form>
                    <hr>
                    <dl></dl>
                    <form action="cobros.php" class="form-inline" method="POST" target="_blank">
                        <h5 class="col-sm-4"><b>INFORME - COBROS VENTA</b></h5><input type="submit" class="btn btn-block btn-warning col-sm-1" value="VISUALIZAR"><BR><BR>
                    </form>
                    <hr>
                    <dl></dl>
                    <form action="nota_credito.php" class="form-inline" method="POST" target="_blank">
                        <h5 class="col-sm-4"><b>INFORME - NOTA CREDITO / DEBITO VENTA</b></h5><input type="submit" class="btn btn-block btn-warning col-sm-1" value="VISUALIZAR"><BR><BR>
                    </form>
                    <hr>
                    <dl></dl>
                    <form action="nota_remision.php" class="form-inline" method="POST" target="_blank">
                        <h5 class="col-sm-4"><b>INFORME - NOTA REMISION VENTA</b></h5><input type="submit" class="btn btn-block btn-warning col-sm-1" value="VISUALIZAR"><BR><BR>
                    </form>
                    <hr>
