      ...
      <div class="content-wrapper">
        <div class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-11">
                  <h1 class="m-0 text-bold text-center"><b>INFORMES COMPRAS</b></h1>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                    <form action="ajuste.php" class="form-inline" method="POST" target="_blank">
                        <h5 class="col-sm-4"><b>INFORME - AJUSTE DE STOCK</b></h5><input type="submit" class="btn btn-block btn-success col-sm-2" value="VISUALIZAR AJUSTE STOCK"><BR><BR>
                    </form>
                    <hr>
