...
<html>
  ...
  <body class="hold-transition sidebar-mini layout-fixed">
      ...
      <div class="content-wrapper">
        <div class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-8">
                  <h1 class="m-0 text-success text-left"><b>FASCY SHOP S.A</b></h1>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                    ...
                    <LABEL>REPORTE - NOTA CRÉDITO/DÉBITO COMPRA </LABEL>&nbsp;&nbsp;<img src="../../iconos/fascy2.png" width="70px" height="60px">
                </div>
    ...
    <script src="funciones_debito-credito.js"></script>
