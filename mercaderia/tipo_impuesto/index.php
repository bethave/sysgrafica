            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <input class="form-control" type="text" id="descripcion_agregar" autofocus="true" placeholder="Nuevo Tipo Impuesto">
                  <input class="form-control" type="number" id="gentilicio_agregar" autofocus="true" placeholder="Nuevo Valor">
                </div>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <input class="form-control" type="number" id="gentilicio_editar" value="" autofocus="true">
                  <input type="hidden" id="descripcion_anterior_editar" value="">
                  <input type="hidden" id="gentilicio_anterior_editar" value="">
