...
function grabar_cabecera(){
    ...
    var asig_motivo;
    var asig_monto;
    caja_id = $("#id_caja_cabecera").val();
    asig_motivo = $("#id_mot_cabecera").val();
    asig_monto = $("#id_monto_cabecera").val();
    //alert(con_pedido);
    $.ajax({
    type: "POST", url: "grabar.php",
      data: {
          id_oc : '0', 
          caja_id: caja_id,
          asig_motivo: asig_motivo,
          asig_monto: asig_monto,
          operacion: '1'
      }
    }).done(function(resultado){
...
function imprimir(){
    ...
    window.open ("../../tcpdf/examples/example_asignacion.php?codigo="+id_oc);
}