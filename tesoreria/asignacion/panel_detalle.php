<?php
	...
	$pedidos = pg_query($conexion, "SELECT * FROM v_venta_presupuesto WHERE pre_estado = 'CONFIRMADO';");
 	$ped = pg_fetch_all($pedidos);
        $pedidos_detalles = pg_query($conexion, "SELECT * FROM v_venta_presupuesto_detalle WHERE pre_cod IN (SELECT pre_cod FROM venta_presupuesto WHERE pre_estado = 'CONFIRMADO');");
...
<div class="row">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <b>Con Orden de Pago: </b><?php echo $cab[0]['con_presu'];?><br>
...
<div class="row">
    <div class="card col-sm-12">
        ...
        <div class="card-body">
            <?php if(empty($ped)){?>
            <label style="color:red">NO HAY ORDEN DE PAGO DISPONIBLES</label>
            <?php }else{?>
                    ...
                    <div class="row" id="contenedor<?php echo $p['pre_cod'];?>">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <b>Nro Orden de Pago: </b><?php echo $p['pre_cod'];?>&nbsp;&nbsp;
...
<?php } ?>
<div class="row">
    <button type="button" class="btn btn-primary" onclick="grabar_pedidos(<?php echo $cab[0]['fac_cod'];?>);">GRABAR ORDEN DE PAGO</button>
</div>
<div class="row">
    <div class="card col-sm-12">
        <div class="card-header p-0">
        ...
        <div class="card-body">
            ...
            <?php }else{ ?>
                ...
                <b>INGRESE MONTO DE ASIGNACION</b>
