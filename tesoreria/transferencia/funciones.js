...
function grabar_cabecera(){
    ...
    var tb_cta_titular;
    var tb_beneficiario;
    var tb_cta_beneficiario;
    var tb_concepto;
    var tb_importe;
    var cuen_bank;
    tb_titular = $("#id_ti_cabecera").val();
    tb_cta_titular = $("#id_cti_cabecera").val();
    tb_beneficiario = $("#id_ben_cabecera").val();
    tb_cta_beneficiario = $("#id_ctb_cabecera").val();
    tb_concepto = $("#id_concepto_cabecera").val();
    tb_importe = $("#id_im_cabecera").val();
    cuen_bank = $("#id_cuen_cabecera").val();
    //alert(con_pedido);
    $.ajax({
    type: "POST", url: "grabar.php",
      data: {
          id_oc : '0', 
          tb_titular: tb_titular,
          tb_cta_titular: tb_cta_titular,
          tb_beneficiario: tb_beneficiario,
          tb_cta_beneficiario: tb_cta_beneficiario, 
          tb_concepto: tb_concepto, 
          tb_importe: tb_importe,
          cuen_bank: cuen_bank, 
          operacion: '1'
      }
    }).done(function(resultado){
...
function imprimir(){
    ...
    window.open ("../../tcpdf/examples/example_transferencia.php?codigo="+id_oc);
}