...
function grabar_cabecera(){
    ...
    if($("#con_che_cabecera").prop('checked')){
        con_cheque = 't';
    }else{
        con_cheque = 'f';
    }
    if($("#con_ord_cabecera").prop('checked')){
        con_orden = 't';
    }else{
        con_orden = 'f';
    }
...
function imprimir(){
    ...
    window.open ("../../tcpdf/examples/example_remision_venta.php?codigo="+id_oc);
}