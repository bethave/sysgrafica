...
<div class="row">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <b>Con Banco: </b><?php echo $cab[0]['con_fac'];?><br>
...
<div class="row">
    <div class="card col-sm-12">
        <div class="card-header p-0">
            <b>SELECCIONE COBROS</b>
        </div>
        <div class="card-body">
            <?php if(empty($ped)){?>
            <label style="color:red">NO HAY BANCOS DISPONIBLES</label>
            <?php }else{?>
                    ...
                    <div class="row" id="contenedor<?php echo $p['fac_cod'];?>">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <b>Nro Banco: </b><?php echo $p['fac_cod'];?>&nbsp;&nbsp;
...
<?php } ?>
<div class="row">
    <button type="button" class="btn btn-primary" onclick="grabar_pedidos(<?php echo $cab[0]['cred_cod'];?>);">GRABAR BANCOS</button>
</div>
<div class="row">
    <div class="card col-sm-12">
        <div class="card-header p-0">
        ...
        <div class="card-body">
            ...
            <?php }else{ ?>
                ...
                <div class="card-header p-0">
                    <b style="color: green">TIPO DE OPERACION: EFECTIVO</b>
        </div>
                <b>INGRESE IMPORTE</b>
                <input type="number" class="form-control col-sm-6" id="cantidad_detalle"><br>
                
                <div class="card-header p-0">
                    <b style="color: greenyellow">TIPO DE OPERACION: CHEQUE</b>
        </div>
                <b>INGRESE N° DE CHEQUE</b>
                <input type="number" class="form-control col-sm-6" id="cantidad_detalle"><br>
                <b>INGRESE TIPO DE CHEQUE</b>
                <input type="number" class="form-control col-sm-6" id="cantidad_detalle"><br>
                <b>INGRESE IMPORTE CHEQUE</b>
                <input type="number" class="form-control col-sm-6" id="cantidad_detalle"><br>
...
<div class="row">
<?php if (empty($det)) { ?>
<label style="color: red">NO SE ENCUENTRAN DETALLES PARA ESTA BOLETA</label>
<?php }else{ ?>
