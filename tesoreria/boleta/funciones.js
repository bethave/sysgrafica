...
function grabar_cabecera(){
    ...
    var bdep_importe;
    var cuen_bank;
    bdep_nro = $("#id_nro_cabecera").val();
    tip_cod = $("#id_td_cabecera").val();
    bdep_tipoope = $("#id_to_cabecera").val();
    che_cod = $("#id_ch_cabecera").val();
    bdep_importe = $("#id_imp_cabecera").val();
    ...
    type: "POST", url: "grabar.php",
      data: {
          ...
          bdep_nro: bdep_nro,
          tip_cod: tip_cod,
          bdep_tipoope: bdep_tipoope,
          che_cod: che_cod, 
          bdep_importe: bdep_importe, 
          cuen_bank: cuen_bank, 
          operacion: '1'
      }
    }).done(function(resultado){
...
function imprimir(){
    ...
    window.open ("../../tcpdf/examples/example_bdep.php?codigo="+id_oc);
}