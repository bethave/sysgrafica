...
function grabar_cabecera(){
    ...
    pag_formapag = $("#id_fp_cabecera").val();
    pag_obs = $("#id_obs_cabecera").val();
    cuen_bank = $("#id_cb_cabecera").val();
    if($("#con_oc_cabecera").prop('checked')){
        con_ordcompra = 't';
    }else{
        con_ordcompra = 'f';
    }
    ...
    type: "POST", url: "grabar.php",
      data: {
          id_oc : '0', 
          id_pro: id_pro,
          pag_formapag: pag_formapag,
          pag_obs: pag_obs, 
          cuen_bank: cuen_bank,
          con_ordcompra: con_ordcompra,
          id_co: '0', 
          dop_monto: '0', 
          operacion: '1'
      }
...
function imprimir(){
    ...
    window.open ("../../tcpdf/examples/example_presupuesto_venta.php?codigo="+id_oc);
}