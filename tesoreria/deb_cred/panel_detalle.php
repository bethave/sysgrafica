...
<div class="row">
    <div class="card col-sm-12">
        <div class="card-header p-0">
            <b>SELECCIONE BANCO</b>
        </div>
        <div class="card-body">
            <?php if(empty($ped)){?>
            <label style="color:red">NO HAY BANCO DISPONIBLES</label>
            <?php }else{?>
...
<?php } ?>
<div class="row">
    <button type="button" class="btn btn-primary" onclick="grabar_pedidos(<?php echo $cab[0]['cred_cod'];?>);">GRABAR BANCO</button>
</div>
<div class="row">
    <div class="card col-sm-12">
        <div class="card-header p-0">
