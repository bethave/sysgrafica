...
function grabar_cabecera(){
    ...
    var cuen_bank;
    var con_ban;
    otr_nro = $("#id_nro_cabecera").val();
    otr_tipo = $("#id_tp_cabecera").val();
    otr_motivo = $("#id_mot_cabecera").val();
...
function imprimir(){
    ...
    window.open ("../../tcpdf/examples/example_credito_venta.php?codigo="+id_oc);
}