      ...
      <div class="content-wrapper">
        <div class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1 class="m-0 text-dark">PAGO A PROVEEDORES</h1>
            ...
            <div class="card">
                <div class="card-header p-0">
                    <ul class="nav nav-pills ml-auto p-2">
                        <li class="nav-item"><a class="nav-link active" href="#panel-orden" id="btn-panel-orden" data-toggle="tab">Pagos</a></li>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <input class="form-control" type="number" id="monto_editar" value="">
                            <input type="hidden" id="id_ped_editar" value="">
                            <input type="hidden" id="id_cuen_editar" value="">
                            <input type="hidden" id="id_fac_editar" value="">
                            <input type="hidden" id="id_fc_editar" value="">
                            <input type="hidden" id="id_ban_editar" value="">
                        </div>
