...
<div class="row">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <b>Con Orden de Pago: </b><?php echo $cab[0]['con_fac'];?><br>
...
<div class="row">
    <div class="card col-sm-12">
        <div class="card-header p-0">
            <b>SELECCIONE ORDEN DE PAGO</b>
        </div>
        <div class="card-body">
            <?php if(empty($ped)){?>
            <label style="color:red">NO HAY ORDENES DE PAGO DISPONIBLES</label>
            <?php }else{?>
                    ...
                    <div class="row" id="contenedor<?php echo $p['fac_cod'];?>">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <b>Nro Oorden de Pago: </b><?php echo $p['fac_cod'];?>&nbsp;&nbsp;
...
<?php } ?>
<div class="row">
    <button type="button" class="btn btn-primary" onclick="grabar_pedidos(<?php echo $cab[0]['cred_cod'];?>);">GRABAR ORDEN DE PAGO</button>
</div>
<div class="row">
    <div class="card col-sm-12">
        <div class="card-header p-0">
...
<div class="row">
<?php if (empty($det)) { ?>
<label style="color: red">NO SE ENCUENTRAN DETALLES</label>
<?php }else{ ?>
