...
function grabar_cabecera(){
    ...
    var id_pro;
    var che_cod;
    en_che_concepto = $("#id_con_cabecera").val();
    id_pro = $("#id_pro_cabecera").val();
    che_cod = $("#id_cheq_cabecera").val();    
    //alert(con_pedido);
    $.ajax({
    type: "POST", url: "grabar.php",
      data: {
          id_oc : '0', 
          en_che_concepto: en_che_concepto,
          id_pro: id_pro,
          che_cod: che_cod,
          operacion: '1'
      }
...
function imprimir(){
    ...
    window.open ("../../tcpdf/examples/example_cheque.php?codigo="+id_oc);
}