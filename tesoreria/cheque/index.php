...
<html>
  <head>
    ...
    <link rel="icon" href="/sysgrafica/iconos/ferre.png" type="jpeg">
      ...
      <div class="content-wrapper">
        <div class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1 class="m-0 text-dark">ENTREGA DE CHEQUES</h1>
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item active">TESORIA</li>
                  <li class="breadcrumb-item active">ENTREGA DE CHEQUES</li>
                </ol>
              </div>
            </div>
          </div>
            ...
            <div class="card">
                <div class="card-header p-0">
                    <ul class="nav nav-pills ml-auto p-2">
                        <li class="nav-item"><a class="nav-link active" href="#panel-orden" id="btn-panel-orden" data-toggle="tab">ENTREGA DE CHEQUE</a></li>
