...
<div class="row">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <b>Con Rendicion: </b><?php echo $cab[0]['con_fac'];?><br>
...
<div class="row">
    <div class="card col-sm-12">
        <div class="card-header p-0">
            <b>SELECCIONE RENDICION</b>
        </div>
        <div class="card-body">
            <?php if(empty($ped)){?>
            <label style="color:red">NO HAY RENDICION DISPONIBLE</label>
            <?php }else{?>
                    ...
                    <div class="row" id="contenedor<?php echo $p['fac_cod'];?>">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <b>Nro Rendicion: </b><?php echo $p['fac_cod'];?>&nbsp;&nbsp;
...
<div class="row">
<?php if (empty($det)) { ?>
<label style="color: red">NO SE ENCUENTRAN DETALLES PARA ESTA REPOSICION</label>
<?php }else{ ?>
<table id="tabla_panel_pedido" class="table table-bordered table-striped">
	<thead>
		<tr>
			<th>Nro Reposicion</th>
			<th>Nro Rendicion</th>
			<th>Monto Total</th>
                        <th>Monto Gastado</th>
