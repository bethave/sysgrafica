...
<div class="row">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <b>Con Cobro Tarjeta: </b><?php echo $cab[0]['con_fac'];?><br>
...
<div class="row">
    <div class="card col-sm-12">
        <div class="card-header p-0">
            <b>SELECCIONE ENTIDAD</b>
        </div>
        <div class="card-body">
            <?php if(empty($ped)){?>
            <label style="color:red">NO HAY ENTIDAD DISPONIBLES</label>
            <?php }else{?>
                    ...
                    <div class="row" id="contenedor<?php echo $p['fac_cod'];?>">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <b>Nro Entidad: </b><?php echo $p['fac_cod'];?>&nbsp;&nbsp;
...
<?php } ?>
<div class="row">
    <button type="button" class="btn btn-primary" onclick="grabar_pedidos(<?php echo $cab[0]['cred_cod'];?>);">GRABAR ENTIDAD</button>
</div>
<div class="row">
    <div class="card col-sm-12">
        <div class="card-header p-0">
