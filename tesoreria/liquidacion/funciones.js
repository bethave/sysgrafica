...
function grabar_cabecera(){
    ...
    var liq_concepto;
    var liq_total;
    liq_nro = $("#id_nro_cabecera").val();
    liq_descri = $("#id_des_cabecera").val();
    ent_cod = $("#id_ent_cabecera").val();
    cuen_bank = $("#id_cb_cabecera").val();
    liq_concepto = $("#id_con_cabecera").val();
    liq_total = $("#id_total_cabecera").val();
    ...
    type: "POST", url: "grabar.php",
      data: {
          id_oc : '0', 
          liq_nro: liq_nro,
          liq_descri: liq_descri,
          ent_cod: ent_cod,
          cuen_bank: cuen_bank, 
          liq_concepto: liq_concepto, 
          liq_total: liq_total,
          operacion: '1'
      }
    }).done(function(resultado){
...
function imprimir(){
    ...
    window.open ("../../tcpdf/examples/example_liquidacion.php?codigo="+id_oc);
}